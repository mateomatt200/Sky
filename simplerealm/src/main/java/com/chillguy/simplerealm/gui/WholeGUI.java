...
import com.chillguy.simplerealm.gui.allrealms.*;
import com.chillguy.simplerealm.realm.RealmPlayer;
import com.venned.simpleinventory.SmartInventory;
import com.venned.simplerealm.gui.allrealms.*;
...
public class WholeGUI {
    ...
    public void openAllMoneyGUI(Player player,int money) {
        getAllMoneyGUI(player,money).open(player);
    }
    ...
    public SmartInventory getAllMoneyGUI(Player player,int money) {
        return SmartInventory.builder()
                .provider(new AllMoneyProvider(player,money))
                .size(1, 9)
                .title("Select a Realm")
                .build();
