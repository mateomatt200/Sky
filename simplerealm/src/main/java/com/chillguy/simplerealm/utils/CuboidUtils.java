...
public class CuboidUtils implements Cloneable, ConfigurationSerializable, Iterable<Block> {
    ...
    public void setMinimumPoint(Vector minimumPoint) {
        this.minimumPoint.copy(minimumPoint);
    }

    public void setMaximumPoint(Vector maximumPoint) {
        this.maximumPoint.copy(maximumPoint);
    }

    public void expandToFit(CuboidUtils other) {
        this.minimumPoint.setX(Math.min(this.minimumPoint.getX(), other.getLowerX()));
        this.maximumPoint.setX(Math.max(this.maximumPoint.getX(), other.getUpperX()));
    }
