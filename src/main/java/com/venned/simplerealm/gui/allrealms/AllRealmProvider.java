package com.venned.simplerealm.gui.allrealms;
...
public class AllRealmProvider implements InventoryProvider {
    ...
    public void init(Player player, InventoryContents inventoryContents) {
        ...
        for (Realm r : realms) {
            ClickableItem cl = ClickableItem.of(new ItemsUtils(Material.DARK_OAK_STAIRS
    ...
    public void placeIfVoid(ClickableItem clickableItem, InventoryContents inventoryContents) {
        ...
        while (!iterator.ended()) {
            if (iterator.get().isPresent() && iterator.get().get().getItem().getType() == Material.GREEN_STAINED_GLASS_PANE) {
